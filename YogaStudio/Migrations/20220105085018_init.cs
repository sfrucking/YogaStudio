    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonSubscription", x => new { x.LessonsId, x.SubscriptionsId });
                    table.ForeignKey(
                        name: "FK_LessonSubscription_lessons_LessonsId",
                        column: x => x.LessonsId,
                        principalTable: "lessons",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonSubscription_subscriptions_SubscriptionsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonSubscription_SubscriptionsId",
